    ...
    async (session) => {
      ...
      const attachments = engagements.value.map((engagement) => {
        ...
        return new builder.HeroCard(session)
          ...
          .text(overview)
          .buttons([
            builder.CardAction.openUrl(session, `${process.env.MICROSOFT_RESOURCE_CRM}/main.aspx?etc=10096&extraqs=formid=33679b2b-bfd5-4e84-a63d-13aa63146ebb&pagetype=entityrecord&id=%3D${engagement.ee_projectid}%3D`, 'Browser'),
